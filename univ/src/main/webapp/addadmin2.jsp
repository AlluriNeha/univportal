...
<table class="table" >
		...
		<%  
			...
			out.println ("Creating Admin with following details: <br> <br> " + "Id    :" + aid +  "<br>Name   :" + name + "<br>Dept  " + dept +  "<br> <br><br>");			
			String status = new Utils().addAdmin(aid, name, dept, password);			
			out.println (status);						
		%>
		<br>
