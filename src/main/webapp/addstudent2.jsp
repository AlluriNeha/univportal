...
<table class="table" >
		...
		<%  
			...
			out.println ("Creating Student with following details: <br> <br> " + "Id  : " + sid +  "<br>Name :  " + name + "<br>Phone  :" + phone + " <br> " + " Birth Day: " + bdate + "<br>");			
			String status = new Utils().addStudent(sid, name, phone, password, bdate);			
			out.println (status);				
