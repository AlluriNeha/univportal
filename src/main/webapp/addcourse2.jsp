...
<table class="table" >
		...
		<%  
			...
			String status = new Utils().addCourse(cid, name,dept, credits);
			out.println ("Creating Course with following details: <br> <br> " + "Id    :" + cid+  "<br>Credits   :" + credits +  "<br>Name   :" + name + "<br>Dept  " + dept +  "<br> <br><br>");			
