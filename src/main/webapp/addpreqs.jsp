	...
	<table  class="table" >
		...
		<tr>
			...
			<%  
				...
				String str2= "Enter details of prereqs to add to course Dept:" + c.dname +  " Name:" + c.cname+ "<br>";				
				out.println(str2);
			%>
			</td>
		</tr>
		<tr>
			<td>
				...
				<form method="post" action="addpreqs2.jsp">
						<table>
						<tr><td>Course Id</td><td> <input type="text" name="cid" value="<%=course%>" readonly/></td></tr>
						<tr><td>Pre Req Course Id</td><td> <input type="text" name="prid"/></td></tr>
